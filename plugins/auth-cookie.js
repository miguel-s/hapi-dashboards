...
exports.register.attributes = {
  name: 'DashboardsAuthCookie',
};

exports.options = internals.options = {
  cacheOptions: { segment: 'dashboards-sessions', expiresIn: 3 * 24 * 60 * 60 * 1000 },
  password: process.env.COOKIE_SECRET,
  cookie: 'dashboards-sid',
  redirectTo: '/login',
  appendNext: true,
  isHttpOnly: true,
  isSecure: process.env.NODE_ENV === 'production',
  requestDecoratorName: 'cookieAuthDashboards',
};
...
internals.after = (server, next) => {
  ...
  server.auth.strategy('dashboards-session', 'cookie', false, {
